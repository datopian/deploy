...
openssl aes-256-cbc -K $encrypted_93b308bc8a42_key -iv $encrypted_93b308bc8a42_iv -in environments/datahub-testing/k8s-ops-secret.json.enc -out environments/datahub-testing/secret-k8s-ops.json -d
